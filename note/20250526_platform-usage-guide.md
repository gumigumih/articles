...
<!-- 
図解内容：
- 3つのプラットフォームの総合比較表（基本情報＋記事特徴を統合）
- 上段：基本情報（読者層、技術レベル、投稿内容の傾向、特徴）
- 下段：記事特徴（メインコンテンツ、文体、タイトル例、読了時間、期待する反応）
- 🔵 Qiita：エンジニア、技術レベル高、コードブロック、手順書調、「〜の作り方」、5-10分
- 🟣 Zenn：エンジニア+α、技術レベル中〜高、図解・表、考察調、「なぜ〜したのか」、10-15分  
- 🟡 note：一般ユーザー、技術レベル低〜中、文章・体験談、物語調、「〜をやってみた話」、15-20分
- 各プラットフォームのロゴカラーに合わせた色分け
- アイコンで視覚化したグリッド形式で見やすく配置
-->

![プラットフォーム総合比較表](images/20250526_platform-usage-guide/platform-overview.png)
...
- No→ 🟡 note（キャリア・体験談）
- Yes→ 「How to？ / Why？」で分岐
  - How to（実装方法）→ 🔵 Qiita（具体的なコード・手順書スタイル）
  - Why（設計思想）→ 🟣 Zenn（考察・背景・図解中心）
- 各プラットフォームを色分け（note:黄色、Qiita:青色、Zenn:紫色）
-->
...
図解内容：
- 横向きフロー（左から右へ）
- 記事アイデア💭 → ガイドライン.md準備📄 → AIに相談🤖（ChatGPT等） → 投稿先決定✅ → 記事執筆開始✍️
- 各ステップを異なる色で表現（黄色→青色→紫色→緑色→オレンジ色）
- アイコン付きで親しみやすいデザイン
-->

![AI活用フロー図](images/20250526_platform-usage-guide/ai-flow.png)
