...
note_id: "n19ae2c3330a9"
note_hashtags: "#ディレクション #プロジェクトマネジメント #仕事術 #スキルアップ #キャリア #PM #ディレクター"
date: 2025-09-19
---

![CoverImage](images/20250919_learn-new-domains-3-tips-director/cover.png)
...
- 「3Dキャラクターをモデリングする」→「実際の制作工程はどうなっている？3面図の正面と横の立体不整合はどうする？どのツール（Maya、Blender等）を使う？ポリゴン数の基準は？テクスチャやリギングの工程はどう進める？」
...
私も最初は「3Dモデル制作なんて全然分からない...」って状態でしたが、Blenderのチュートリアルを見まくって、基本的な流れを理解してからディレクションに臨むようになりました。すると、モデラーさんとの会話で「ここの画角の表示は何ミリに設定してます？200mmに設定して欲しいです」みたいな具体的な提案ができるようになったんです。

以前は90mmで作ってきて、めっちゃ歪んでしまったこともありました。
...
- [退職を機に振り返る。気づいたら何でも屋になっていたエンジニアの軌跡　【プロダクト開発ジェネラリストの軌跡 第0回】](https://note.com/gumigumih/n/nce988ef9dfd9)
